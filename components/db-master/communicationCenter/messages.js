...
module.exports = {
	...
	/*
   * Insert query into cmc_message table
   */
  insert: (tableName,insertParam, callback) => {
	...
	/*
   * Delete query in cmc_message table
   */
  delete : (tableName, conditions, updateParam, callback) => {
	...
	/*
   * Update query in cmc_message table
   */
	...
	/*
	 * Select All Recurring Messages Records With Start and End Time
	 */
 ...
 //    .innerJoin(
 //      'cmc_messages_recurring_mapping as t2',
 //      't1.event_id',
 //      't2.cmc_event_id')
 //    .where({
 //      't1.hotel_id': 1,
 ...
 //  },
	...
	/*
   * Parmanent Delete from cmc_message table
   */
